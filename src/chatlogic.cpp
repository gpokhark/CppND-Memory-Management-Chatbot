...
void ChatLogic::LoadAnswerGraphFromFile(std::string filename) {
  ...
  // Setting the root node for the object (rootNode is the raw pointer from a
  // unique_ptr, does this cause ownership problems?)
  stackBot.SetRootNode(rootNode);
  stackBot.SetChatLogicHandle(this);

  // Moving the ChatBot instance into the root node, along with the pointer to
  // the ChatBot object owned by ChatLogic
